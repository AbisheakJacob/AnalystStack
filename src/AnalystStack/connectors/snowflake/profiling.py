...
class ProfilerManager:
    ...
    Args:
        query_manager: The `AnalystStack.connectors.snowflake.query.QueryManager` used to
            run the generated profiling query.
        metadata_manager: The `AnalystStack.connectors.snowflake.metadata.MetadataManager`
    ...
    def profile_columns(self, schema: str, table_id: str) -> pd.DataFrame:
        ...
        selects = [f'COUNT("{col}") AS "{col}"' for col in column_names]
        sql_select = ",\n".join(selects)
